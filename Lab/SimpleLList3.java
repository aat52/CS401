...
public class SimpleLList
{
	...
	// Return true if the data
     // in SimpleList arg exactly matches the data in the current
     // SimpleList.  All Strings must match in the order stored.
	...
	{ 	 
        ...
        if  (arg instanceof SimpleLList) 
         {
         SimpleLList argSimpleLList   = (SimpleLList)arg;
         int n = size();
         if (n == argSimpleLList.size()) 
			{
            Node n1 = front;
            Node n2 = argSimpleLList.front;
            while (n1 != null) {
