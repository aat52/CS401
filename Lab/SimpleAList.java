...
{
	// Note the two incapsulated variables -- an array to store
	// the data and an int to keep track of the size.
	private String [] data;
	private int size;
	...
	// the capacity (which he / she does not need to know).
	public SimpleAList()
	{
		size = 0;
		data = new String[4];
	...
	// Resize list.  Note that this is private and not public.  We do not want
	// the user to explicitly resize the this -- resizing is an implicit
