...
// lab5out.txt
/*
The constructors work correctly (1 point)
The area method works correctly (1 point)
The isInside method works correctly (1 point)
The "set" methods work correctly (1 point)
*/
...
public class Lab5
{
	...
	{
		//find if points are inside or outside the set rectangle
	...
	public static void main(String [] args)
	{
		...
		//when Objects are printed,the toString() method is implicitly called
		//thus the statements below will call toString() for each of the three MyRectangle objects
